...
extern uint8_t m_i2cAddress;      ///< the I2C address
extern uint8_t m_conversionDelay; ///< conversion deay
extern uint8_t m_bitShift;        ///< bit shift amount
extern uint16_t m_gain;          ///< ADC gain
extern uint8_t sweep_chan;
extern uint8_t flag_started_timeout[N_CHAN_ADS];
extern uint16_t adc_buffer[N_CHAN_ADS];
